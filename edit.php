  ...
  <body>
    <div class="container pt-5">
      ...
      <form method="POST" action="proses-edit.php" class="mt-3">
        ...
        <a href="index.php" class="btn btn-danger" id="cancel-edit">Cancel</a>

      </form>
      <script>
          $(document).ready(function () {
            $("#cancel-edit").click(function () {
              if (confirm('Are you sure you want to cancel the editing process? The data will not be saved.')) {
